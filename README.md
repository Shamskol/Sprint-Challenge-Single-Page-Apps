...
> Answer:
A client-side routing does occur when the routing is beig internally handled by JS that is loaded on the page.
The benefits are :
-Generally routing is faster because less data is processed
-Implementation of smooth transitions and animations between views are easier
